...
// import { CALENDAR_BODY_HEIGHT } from '../../components/lightCalendar/constants';
// import { TaskTimeline, MarkedObject } from '../../components/lightCalendar/type';
//
...
//
//
//     //     const pro1 = LabelDAO.addLabel({name: "WORKING", color: Colors.primary.orange, numberOfTasks: 4, numberOfCompletedTasks: 3})
//     //     const pro2 = LabelDAO.addLabel({name: "STUDY", color: Colors.primary.teal});
//     //     const pro3 = LabelDAO.addLabel({name: "FREE TIME", color: Colors.primary.red});
//
